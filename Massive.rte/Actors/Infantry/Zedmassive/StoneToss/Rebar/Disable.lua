function OnDetach(self)
	...
	if self.wasThrown == true then
		...
		self:EnableScript("Massive.rte/Actors/Infantry/Zedmassive/StoneToss/Rebar/TwirlBluntThrow.lua");
	...
	self:DisableScript("Massive.rte/Actors/Infantry/Zedmassive/StoneToss/Rebar/Rebar.lua");
...
function OnAttach(self)
	...
	self:DisableScript("Massive.rte/Actors/Infantry/Zedmassive/StoneToss/Rebar/TwirlBluntThrow.lua");
	self.PinStrength = 0;

	self:EnableScript("Massive.rte/Actors/Infantry/Zedmassive/StoneToss/Rebar/Rebar.lua");
