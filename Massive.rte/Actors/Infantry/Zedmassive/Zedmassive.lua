...
require("Actors/Infantry/Zedmassive/ZedmassiveAIBehaviours")
...
function Create(self)
	...
	self.IdentityPrimary = "Zedmassive";
	...
	BattleScreamReverbPre = CreateSoundContainer("VO " .. self.IdentityPrimary .. " BattleScreamReverbPre", "Massive.rte"),
	Breathing = CreateSoundContainer("VO " .. self.IdentityPrimary .. " Breathing", "Massive.rte"),
	DeathFinal = CreateSoundContainer("VO " .. self.IdentityPrimary .. " DeathFinal", "Massive.rte"),
	...
	Vocalize = CreateSoundContainer("VO " .. self.IdentityPrimary .. " Vocalize", "Massive.rte"),
	};
	
	self.battleScreamImpact = CreateSoundContainer("BattleScreamImpact Zedmassive", "Massive.rte");
	...
	ZedmassiveAIBehaviours.createVoiceSoundEffect(self, self.voiceSounds.Intro, 3)
...
function Update(self)
	...
	if (self.Dying ~= true) then
		...
		ZedmassiveAIBehaviours.handleMovement(self);
		
		ZedmassiveAIBehaviours.handleHealth(self);
		
		ZedmassiveAIBehaviours.handleSuppression(self);
		
		ZedmassiveAIBehaviours.handleAITargetLogic(self);
		
		ZedmassiveAIBehaviours.handleVoicelines(self);
		
		ZedmassiveAIBehaviours.DoArmSway(self, (self.Health/self.MaxHealth));	--Argument: shove strength
		
		--ZedmassiveAIBehaviours.handleHeadFrames(self);
	...
	-- CHARGING
		...
		ZedmassiveAIBehaviours.handleDying(self);
	
		ZedmassiveAIBehaviours.handleHeadLoss(self);
	...
	if self.Status == 1 or self.Dying then
		ZedmassiveAIBehaviours.handleRagdoll(self)
	end
