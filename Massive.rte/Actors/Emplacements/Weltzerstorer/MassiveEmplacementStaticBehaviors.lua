...
MassiveEmplacementStaticBehaviors = {}

function MassiveEmplacementStaticBehaviors.Patrol(AI, Owner, Abort)
...
local Proxy = {}
local Mt = {
	__index = MassiveEmplacementStaticBehaviors,
	__newindex = function(Table, k, v)
		error("The TurretBehaviors table is read-only.", 2)
	end
}
setmetatable(Proxy, Mt)
MassiveEmplacementStaticBehaviors = Proxy
