...
function Create(self)
	...
	self.equipSound = CreateSoundContainer("Equip JetAxe Massive", "Massive.rte");

	-- throwing stuff
	
	self.bounceSound = CreateSoundContainer("Thrown Bounce JetAxe Massive", "Massive.rte");
	
	self.throwSound = CreateSoundContainer("Slash JetAxe Massive", "Massive.rte");
	self.throwSoundPlayed = false;
	
	self.spinSound = CreateSoundContainer("Spin JetAxe Massive", "Massive.rte");
	self.spinTimer = Timer();
	self.spinDelay = 145;
	
	self.terrainSounds = {
	Impact = {[12] = CreateSoundContainer("Impact Concrete JetAxe Massive", "Massive.rte"),
			[164] = CreateSoundContainer("Impact Concrete JetAxe Massive", "Massive.rte"),
			[177] = CreateSoundContainer("Impact Concrete JetAxe Massive", "Massive.rte"),
			[9] = CreateSoundContainer("Impact Dirt JetAxe Massive", "Massive.rte"),
			[10] = CreateSoundContainer("Impact Dirt JetAxe Massive", "Massive.rte"),
			[11] = CreateSoundContainer("Impact Dirt JetAxe Massive", "Massive.rte"),
			[128] = CreateSoundContainer("Impact Dirt JetAxe Massive", "Massive.rte"),
			[6] = CreateSoundContainer("Impact Sand JetAxe Massive", "Massive.rte"),
			[8] = CreateSoundContainer("Impact Sand JetAxe Massive", "Massive.rte"),
			[178] = CreateSoundContainer("Impact SolidMetal JetAxe Massive", "Massive.rte"),
			[179] = CreateSoundContainer("Impact SolidMetal JetAxe Massive", "Massive.rte"),
			[180] = CreateSoundContainer("Impact SolidMetal JetAxe Massive", "Massive.rte"),
			[181] = CreateSoundContainer("Impact SolidMetal JetAxe Massive", "Massive.rte"),
			[182] = CreateSoundContainer("Impact SolidMetal JetAxe Massive", "Massive.rte")}}
			
	self.soundHitFlesh = CreateSoundContainer("Impact Flesh JetAxe Massive", "Massive.rte");
	self.soundHitMetal = CreateSoundContainer("Metal JetAxe Massive", "Massive.rte");
	...
	self.terrainHitSounds = 
			{[12] = CreateSoundContainer("Impact Concrete JetAxe Massive", "Massive.rte"),
			[164] = CreateSoundContainer("Impact Concrete JetAxe Massive", "Massive.rte"),
			[177] = CreateSoundContainer("Impact Concrete JetAxe Massive", "Massive.rte"),
			[9] = CreateSoundContainer("Impact Dirt JetAxe Massive", "Massive.rte"),
			[10] = CreateSoundContainer("Impact Dirt JetAxe Massive", "Massive.rte"),
	...
	regularAttackSounds.hitMetalSound = CreateSoundContainer("Metal JetAxe Massive", "Massive.rte");
	...
	slashAttackPhase[i].angleStart = 25
	...
	i = 2
	slashAttackPhase[i] = {}
	slashAttackPhase[i].durationMS = 200
	...
	i = 3
	slashAttackPhase[i] = {}
	slashAttackPhase[i].durationMS = 80
	...
	slashAttackPhase[i].soundStart = CreateSoundContainer("Slash JetAxe Massive", "Massive.rte");
	...
	i = 5
	slashAttackPhase[i] = {}
	slashAttackPhase[i].durationMS = 130
	...
	slashAttackPhase[i].angleEnd = 25
	...
	self:SetStringValue("Attack 1 Name", "Stab");
	...
	stabAttackPhase[i].soundStart = CreateSoundContainer("Slash JetAxe Massive", "Massive.rte");
	...
	horseComboAttackPhase[i].soundStart = CreateSoundContainer("Slash JetAxe Massive", "Massive.rte");
	...
	overheadAttackPhase[i].soundStart = CreateSoundContainer("Slash JetAxe Massive", "Massive.rte");
	...
	flourishPhase[i].soundStart = CreateSoundContainer("Flourish JetAxe Massive", "Massive.rte");
