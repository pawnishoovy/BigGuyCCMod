...
function Create(self)
	...
	self.explodePreBassSound = CreateSoundContainer("Explode Pre Bass Quicket", "Massive.rte");
	self.explodeBassSound = CreateSoundContainer("Explode Bass Quicket", "Massive.rte");
	self.explodeSubBassSound = CreateSoundContainer("Explode Sub Bass Quicket", "Massive.rte");
	self.explodeCoreSound = CreateSoundContainer("Explode Core Quicket", "Massive.rte");
	self.explodeFlavorSound = CreateSoundContainer("Explode Flavor Outdoors Quicket", "Massive.rte");
	self.explodeReflectionOutdoorsSound = CreateSoundContainer("Explode Reflection Outdoors Quicket", "Massive.rte");
	self.explodeReflectionIndoorsSound = CreateSoundContainer("Explode Reflection Indoors Quicket", "Massive.rte");
	...
	self.shakenessParticle.Mass = 100;
	self.shakenessParticle.Lifetime = 1500;
	...
	self.explodePreBassSound:Play(self.Pos);
	self.explodeBassSound:Play(self.Pos);
	self.explodeSubBassSound:Play(self.Pos);
