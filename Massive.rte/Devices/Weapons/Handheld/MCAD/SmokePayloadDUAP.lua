...
function Create(self)
	...
	self.explodeOutdoorsSound = CreateSoundContainer("Explode DUAP Outdoors Massive MCAD", "Massive.rte");
	self.explodeIndoorsSound = CreateSoundContainer("Explode DUAP Indoors Massive MCAD", "Massive.rte");
